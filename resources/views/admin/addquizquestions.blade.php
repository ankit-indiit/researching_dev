          ...
          <div class="card-box">
            <div class="row" style="direction:rtl">
              ...
              <div class="col-md-6 text-left">
                <a href="{{route('admin.addquizoptions').'/'.$quiz_id}}" class="btn btn-primary  mb-3">
                  הוסף שאלות
                </a>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  foreach ($questions as $key => $value) {
                    ...
                    if($type == '0'){
                      ...
                      $option1 = asset('/assets/images/' .$value->optionA);
                      $option2 = asset('/assets/images/' .$value->optionB);
                      $option3 = asset('/assets/images/' .$value->optionC);
                      $option4 = asset('/assets/images/' .$value->optionD);
                      $radio ='image';
                      $answer = $value->answer;
                      $final = '';
                      if($answer == '1'){
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="{{route('admin.editquizoptions').'/'.$value->id}}" class="btn btn-xs btn-success"><i class="mdi mdi-pencil"></i></a>
                    <a data-value ="{{$value->id}}" class="btn btn-xs btn-danger delete_quiz_question"><i class="mdi mdi-trash-can"></i></a>
                  </td>
                </tr>
              <?php }?>
              </tbody>
...
@section('scripts')
    <script>
        $(document).ready(function($) {
            ...
            $('.delete_quiz_question').click(function(){
                var id = $(this).attr('data-value');
                $('#deleted_id').val(id);
                $('#quizquestiondelete').modal('show');
            ...
            $("#delete_data").click(function(e) {
                ...
                $.ajax({
                    url: '{{ route("admin.deletequizquestion") }}',
                    type: 'POST',
                    dataType: 'json',
                        data: {
