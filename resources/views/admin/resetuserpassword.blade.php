...
<div class="account-pages mt-4 mb-3">
    <div class="container">
        <div class="row justify-content-center">
            ...
            @else
                <form  action="{{ route('admin.set_user_password') }}" class="mt-4" method="POST" id="adminLogin">
                            @csrf
                ...
                <div class="col-12 text-center">
                    <p> <a href="{{route('admin.edituser').'/'.$user_id}}" class="text-dark-50 ml-1">חזרה לדף</a></p>
                </div> <!-- end col -->
            </div>
                </div> <!-- end col -->
            </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $.ajax({
            url: '{{ route("admin.set_user_password") }}',
            type: 'POST',
            dataType: 'json',
            data: {
