            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-pattern">
                    <div class="card-body p-4">
                        ...
                        <form  action="{{ route('admin.admin_login') }}" class="mt-4" method="POST" id="adminLogin">
                            @csrf
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p> <a href="{{ route('admin.adminforgotpassword') }}" class="text-dark-50 ml-1">שכחת ססמה?</a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
                </div> <!-- end col -->
