					...
					<div class="panel panel-default">
						  	<div class="panel-heading">
							 	<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#ac1{{$i}}" aria-expanded="false" class="collapsed openeye" data-lecture-id="{{ $topics['id'] }}">
										<strong></strong> {{ $topics['topic_name'] }} <!--מבוא--> 
									</a>
							 	</h4>
						  	</div>
					  	<div id="ac1{{$i}}" class="panel-collapse collapse " aria-expanded="false" style="height: 0px;">
						 	<div class="panel-body p-0">
                    			...
                    			<?php
                    		    if(!empty($topicsVideos)){
                    		        foreach($topicsVideos as $topic_video_key=>$topic_video_val){
                    			?>
                    			<li>
                    			  	<a class="item">
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            async function streamSignedUrl () {
              ...
              jQuery('#player').html("<iframe src='https://iframe.videodelivery.net/"+signedToken+"'></iframe>");
              return signedToken
            }
