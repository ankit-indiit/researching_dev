    ...
    <div class="row sidebar-sec">
      <div class="col-md-12">
        <div class="row">
          ...
          <li class="btnglow"> <a data-toggle="tab" href="#tab2" aria-expanded="false">
                       חבילות במבצע
            </a> 
          </li>
          <li class="active "> <a data-toggle="tab" href="#tab1" aria-expanded="true">
                      קורסים בודדים
            </a> 
          </li>
        </ul>
            ...
            <div class="packagedeal">
              ...
              <div class="packageinner">
                <a class="thumb">
                  ...
                  <div class="info">
                    <h4>
                        <a href="{{route('front.package.show',['id' => $package_courses->course_id,'package_id' => $package->package_code])}}"><h4>{{$package_courses->course_name}}</h4></a>
                    </h4>
